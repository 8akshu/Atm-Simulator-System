...
public class SignUpOne extends JFrame implements ActionListener
{
    ...
    JButton next;
    JRadioButton male , female , other , married, unmarried , othermarrie;
    ...
    public SignUpOne()
    {
        ...
        add(gender);
        //to add radio buuto JRadioButton4
        ...
        female.setBounds(390, 290, 75, 30);
        female.setBackground(Color.WHITE);
        add(female);
        
        other = new JRadioButton("Other");
        other.setBounds(480, 290, 75, 30);
        ...
        othermarrie = new JRadioButton("Other");
        othermarrie.setBounds(490, 390, 75, 30);
        othermarrie.setBackground(Color.WHITE);
        add(othermarrie);
        
        ButtonGroup marritalgroup = new ButtonGroup();
        marritalgroup.add(married);
        marritalgroup.add(unmarried);
        marritalgroup.add(othermarrie);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(othermarrie.isSelected())
        {
            marital = "Other";
        }
